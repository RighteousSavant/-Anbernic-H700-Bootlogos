...
These bootlogos are designed for the Anbernic RGXX family of devices utilizing the Allwinner H700 processor and using the KNULLI custom firmware with a 640×480 (4:3), 720×480 (3:2) and 720×720 (1:1) screen ratios.  These bootlogos are freely available for anyone to use for compatible devices.  
